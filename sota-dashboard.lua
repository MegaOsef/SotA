...
function SOTA_DisplayHelp()
	...
	--SOTA:Print("  range +<dkp>    Add <dkp> to all players in 100 yards range.");
	--SOTA:Print(
	--"  share +<dkp>    Share <dkp> to all players in raid. Every player gets (<dkp> / <number of players in raid>) DKP.");
	...
	--SOTA:Print("Guild/Raid chat commands:");
	--SOTA:Print("  !bid <dkp>    Bid <dkp> for item currently being on auction.");
	--SOTA:Print("  !bid min    Bid the minimum bid on item currently being on auction.");
	--SOTA:Print("  !bid max    Bid everything (go all out) on item currently being on auction");
	--SOTA:Print("  !Pass    Cancel a bid. Only allowed if the cancelled bid is the current active bid.");
	return false;
end
...
--		SOTA:Print("You are already SOTA Master.");
--	else
--		SOTA_RequestMaster();
--	end
--end
...
--	if rank < 1 then
--		if silentmode then
--			debugSOTA:Print(string.format("Player %s have raid rank %d", playername, rank));
--		else
--			SOTA:Print("You must be promoted before you can be a SOTA Master!");
--		end
--		return;
--	end
--
--	addonSOTA:Print("TX_SETMASTER#"..playername.."#");
--
--	if not silentmode then
--		if not CLIENT_STATE == CLIENT_STATE_MASTER then
--			SOTA:Print("You are now SOTA Master.");
--		end	
--	end
--	
...
--	end
--
--	--SOTA:Print(string.format("Master: %s, state= %d", mastername, CLIENT_STATE));
--
...
function SOTA_IsPromoted()
	if not SOTA:IsInRaid(true) then
		return false;
	end 
...
--	local playername = UnitName("player")
--	--SOTA:Print(string.format("TX_MASTER: msg=%s, sender=%s", message, sender));
--
...
--	addonSOTA:Print(string.format("RX_VERSION#%s#%s", GetAddOnMetadata("SOTA", "Version"), sender));
--end
--
----[[
...
--	SOTA:Print(string.format("%s is using %s version %s", sender, SOTA_TITLE, message));
--end
--
--
----[[
...
--		--SOTA:Print(string.format("Message from self, skipping - Msg=%s", message));
--		return
--	end
--
...
--
--	-- Transaction Log:	
--	addonSOTA:Print("RX_SYNCINIT#"..SOTA_currentTransactionID.."#"..sender)
--	
--	-- If this is the MASTER, we should also tell this to the requester.
--	if SOTA_Master then
--		addonSOTA:Print("TX_SETMASTER#".. SOTA_Master .."#"..sender);	
--	end
--	
--end
--
...
--		addonSOTA:Print("TX_SYNCTRAC##"..maxName);	
--	end
--end
--
--
...
--			
--			addonSOTA:Print("RX_SYNCTRAC#"..response.."#"..sender);
--		end
--	end
--	
--	--	Last, send an EOF to signal all transactions were sent.
--	addonSOTA:Print("RX_SYNCTRAC#EOF#"..sender);
--end
--
--
...
----	SOTA:Print("In SOTA_RequestUpdateConfigVersion");
--	addonSOTA:Print("TX_CFGSYNCREQ##");
--end;
--
----[[
...
----	SOTA:Print("In SOTA_HandleTXConfigSyncRequest");
--
...
--	end;
--
--	addonSOTA:Print("RX_CFGSYNCREQ#"..SOTA_CONFIG_VersionNumber..","..SOTA_CONFIG_VersionDate.."#"..sender);
--end;
--
--function SOTA_HandleRXConfigSyncRequest(message, sender)
--	SOTA:Print("In SOTA_HandleRXConfigSyncRequest");
--
--	local _, _, senderVersion, senderDate = string.find(message, "([^,]*),([^,]*)")
--
--	-- TODO: Add this message to list of known versions:
--	SOTA:Print(string.format("Sender=%s, version=%s, date=%s", sender, senderVersion, senderDate));
--end;



--function SOTA:CHAT_MSG_ADDON(prefix, msg, channel, sender)
--	--SOTA:Print(string.format("Prefix=%s, MSG=%s", prefix, msg));
--
...
--		end
--		
--		--SOTA:Print(string.format("Incoming: CMD=%s, MSG=%s, Sender=%s, Recipient: %s", cmd, message, sender, recipient));
--	
...
--		else
--			--gSOTA:Print("Unknown command, raw msg="..msg)
--		end
--	end
--end
...
--			addonSOTA:Print("TX_UPDATE#"..payload.."#");
--		end
--	end
--end
--
